...
- `cert-app/backend/docs/Final_RAG_TECHNIQUES_SUMMARY.md` — **프로젝트 종료본·기법 요약서**(단계별 적용 여부·인수인계)
- `cert-app/backend/docs/Final_RAG_FEATURES.md` — **구현된 RAG 기능 전체 카탈로그**(스위치·모듈·CLI)
