...
SYNONYM_DICT = {
    # SQL/데이터
    "sqld": ["sqld", "sql 개발자", "sql개발자", "SQL개발자", "sql developer"],
    "sql 개발자": ["sqld", "sql 개발자", "sql개발자"],
    "sql개발자": ["sqld", "sql 개발자", "sql개발자"],
    "sqlp": ["sqlp", "sql 전문가", "sql전문가", "SQL전문가"],

    # 데이터 분석
    "adsp": ["adsp", "ADsP", "데이터분석준전문가", "데이터 분석 준전문가", "데분준"],
    "데이터분석준전문가": ["adsp", "ADsP", "데이터분석준전문가", "데이터 분석 준전문가", "데분준"],
    "데분준": ["데분준", "adsp", "ADsP", "데이터분석준전문가"],
    "adp": ["adp", "ADP", "데이터분석전문가", "데이터 분석 전문가", "데분전"],
    "데이터분석전문가": ["adp", "ADP", "데이터분석전문가", "데이터 분석 전문가", "데분전"],
    "데분전": ["데분전", "adp", "ADP", "데이터분석전문가"],

    # 빅데이터
    "빅분기": ["빅분기", "빅데이터분석기사", "빅데이터 분석 기사", "빅데이터분석", "빅데이터기사"],
    "빅데이터분석기사": ["빅분기", "빅데이터분석기사", "빅데이터 분석 기사", "빅데이터기사"],
    "빅데이터기사": ["빅데이터기사", "빅분기", "빅데이터분석기사"],

    # 정보처리
    "정처기": ["정처기", "정보처리기사", "정보 처리 기사"],
    "정보처리기사": ["정처기", "정보처리기사", "정보 처리 기사"],
    "정처산기": ["정처산기", "정처산", "정보처리산업기사", "정보 처리 산업기사"],
    "정처산": ["정처산", "정처산기", "정보처리산업기사", "정보 처리 산업기사"],
    "정보처리산업기사": ["정처산기", "정처산", "정보처리산업기사", "정보 처리 산업기사"],
    "정처기능사": ["정처기능사", "정보처리기능사"],
    "정보처리기능사": ["정처기능사", "정보처리기능사"],
    ...
    "리마1급": ["리마1급", "리마 1급", "리눅스마스터 1급", "리눅스1급"],
    "리눅스1급": ["리눅스1급", "리마1급", "리눅스마스터 1급"],
    "리마2급": ["리마2급", "리마 2급", "리눅스마스터 2급", "리눅스2급"],
    "리눅스2급": ["리눅스2급", "리마2급", "리눅스마스터 2급"],

    # 보안
    "정보보안기사": ["정보보안기사", "정보 보안 기사", "보안기사", "보안 기사"],
    "보안기사": ["보안기사", "정보보안기사", "정보 보안 기사"],
    "정보보안산업기사": ["정보보안산업기사", "보안산업기사"],
    "보안산업기사": ["보안산업기사", "정보보안산업기사"],

    # 컴퓨터활용능력
    "컴활": ["컴활", "컴퓨터활용능력", "컴퓨터 활용능력", "컴활 1급", "컴퓨터활용능력 1급"],
    "컴활1급": ["컴활1급", "컴활 1급", "컴퓨터활용능력 1급"],
    "컴활2급": ["컴활2급", "컴활 2급", "컴퓨터활용능력 2급"],
...
RECOMMENDATION_QUERY_MAP = {
    ...
    # ── 약어·준말 단독 쿼리 ──────────────────────────────────────────────
    "정처기": "정처기 정보처리기사 정보처리 IT 개발 자격증",
    "컴활": "컴활 컴퓨터활용능력 컴퓨터활용 사무 자격증",
    "빅분기": "빅분기 빅데이터분석기사 빅데이터 데이터분석 자격증",
    "sqld": "SQLD sql개발자 SQL데이터베이스 데이터분석 자격증",
    "adsp": "ADsP 데이터분석준전문가 데이터분석 자격증",
    "adp": "ADP 데이터분석전문가 데이터분석 빅데이터 자격증",
    "sqlp": "SQLP sql전문가 SQL데이터베이스 자격증",
    "데분준": "ADsP 데이터분석준전문가 데이터분석 자격증",
    "데분전": "ADP 데이터분석전문가 데이터분석 빅데이터 자격증",
    "리눅스마스터": "리눅스마스터 리눅스 네트워크 서버 IT 자격증",
    "리마1급": "리눅스마스터 1급 리눅스 서버 네트워크 자격증",
    "리마2급": "리눅스마스터 2급 리눅스 서버 입문 자격증",
    "네관사": "네트워크관리사 네트워크 관리 IT인프라 자격증",
    "보안기사": "정보보안기사 정보보안 보안 자격증",
    "정처산기": "정보처리산업기사 정보처리 IT 개발 자격증",
    # ── 비IT 도메인 cert 쿼리 보강 ─────────────────────────────────────────
    "전기기사": "전기기사 전기 전력 자격증 한국산업인력공단",
    "전기관련": "전기기사 전기산업기사 전기 전력 설비 자격증",
    "전기직무": "전기기사 전기산업기사 전기 설비 전력 자격증",
    "회계사": "공인회계사 회계 세무사 세무 재무 자격증",
    "세무사": "세무사 세무 회계 재무 자격증",
    "공인중개사": "공인중개사 부동산 중개 자격증",
    "사회복지사": "사회복지사 사회복지 복지 자격증",
    "간호사": "간호사 간호 의료 보건 자격증",
    "의사": "의사 의학 의료 보건 자격증",
    "건축사": "건축사 건축 건설 자격증",
    "토목기사": "토목기사 토목 건설 자격증",
}
...
RECO_KEYS_SKIP_FOR_CERT_NAME = {
    ...
    for k in (
        ...
        "자격증있어", "뭐가", "추천자격증",
        "인데취업", "인데자격증",
        # 비IT 도메인 쿼리 (cert-centric 에서는 스킵)
        "전기관련", "전기직무", "회계사", "세무사", "공인중개사",
        "사회복지사", "간호사", "의사", "건축사", "토목기사",
    )
}
